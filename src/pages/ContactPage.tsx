...
const ContactPage: React.FC = () => {
  ...
  const contactFaqs = [
    {
      ...
      answer: 'You can reach us via the contact form, email, or phone number provided on this page.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Yes, you are welcome to visit our office during business hours. Please contact us to schedule an appointment.'
    },
    {
      question: 'Do you offer support after business hours?',
      answer: 'For urgent matters, please email us and we will do our best to respond as soon as possible.'
    },
  ];
  ...
  return (
    <>
      ...
      <FaqSection faqs={contactFaqs} title="Contact FAQ" subtitle="Frequently asked questions about contacting us" />
    </>
  );
};
