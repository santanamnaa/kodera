...
const VisionMissionSection: React.FC = () => (
  <section className="bg-gray-100 py-16 px-4">
    <div className="max-w-5xl mx-auto text-center">
      <h2 className="text-3xl font-bold mb-4">Visi, Misi, dan Nilai Perusahaan</h2>
      <div className="mb-8">
      ...
      <h3 className="font-semibold mt-8 mb-4">Nilai Perusahaan: <span className="font-bold">TANGGUH</span></h3>
