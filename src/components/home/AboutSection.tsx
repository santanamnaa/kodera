  ...
  return (
    <section className="bg-black text-white py-16 md:py-24 flex flex-col items-center px-4">
      <div className="text-center max-w-4xl mx-auto">
        ...
        Filosofi nama <span className="font-normal">"AITISERVE DJAYA NARAYA"</span> mencerminkan sinergi antara kecerdasan buatan, teknologi informasi, dan layanan unggulan (AITISERVE), serta kejayaan, harapan, dan kemakmuran (DJAYA NARAYA). Nilai-nilai ini menjadi landasan dalam setiap langkah perusahaan untuk membentuk masa depan digital yang lebih cerdas, berkelanjutan, dan berdampak nyata.
        </p>
      </div>
    </section>
  );
